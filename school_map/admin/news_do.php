...
function data_set(){
        ...
        $newsAttr['title']  = $title;
        $newsAttr['abstract']  = $title;
        //var_dump($newsAttr);exit;
        $newsAttr['desc']  = $content;
        $newsAttr['createtime']  = $datestamp;
        $newsAttr['admin'] = '系统更新';
        var_dump($newsAttr);exit;
        return $newsAttr;
