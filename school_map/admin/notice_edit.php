<?php
  ...
  //获得参数后，率先检查参数的合法性
    ...
    try {
        ...
        $r = Notice::getInfoById($id);
        $notice_id                      = $r['id'];
        $notice_title                   = $r['title'];
        $notice_admin                   = $r['admin'];
        $notice_desc                    = $r['desc'];
        $notice_abstract                = $r['abstract'];
        $notice_createtime              = $r['createtime'];
    } catch(MyException $e){
        echo $e->getMessage();
        exit();
    }
        ...
        <div id="container">
            ...
            <div id="maincontent">
                ...
                <div id="formlist">
                    ...
                    <p>
                        <label>公告标题</label>
                        <input name="title" type="text" class="text-input input-length-50" value="<?php echo $notice_title?> "/>
                        <span class="warn-inline">*</span>
                    </p>
                    <p>
                        <label>内容摘要</label>
                        <textarea name="intro" class="text-area input-length-50" id="notice_intro" ><?php echo $notice_abstract?></textarea>
                        <span class="warn-block">限140字。还能输入<span id="introwordscount" style="color: red;">140</span>字。</span>
                    </p>

                      <p>
                        <label>图文详情</label>
                        <div style="margin-left:156px;width:80%;"><textarea name="desc" id="ck_content"><?php echo $notice_desc?></textarea></div>
                    </p>
