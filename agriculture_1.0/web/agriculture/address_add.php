...
<div class="container">
    ...
    <div class="cart-panel">
        <div class="am-form-group am-form-icon">
            ...
            <input type="text" name="name" class="am-form-field  my-radius" placeholder="收货人姓名">
        </div>
        <div class="am-form-group am-form-icon">
            <i class="am-icon-phone" style="color:#f09513"></i>
            <input type="text" name="phone" class="am-form-field  my-radius" placeholder="请输入11位手机号码">
        </div>
        <div class="am-form-group am-form-icon">
            <i class="am-icon-map-marker" style="color:#e88888"></i>
            <input type="text" name="area" class="am-form-field  my-radius" placeholder="请输入地区，例如河南、郑州">
        </div>
        <div class="am-form-group am-form-icon">
            <i class="am-icon-home" style="color:#329cd9"></i>
            <input type="text" name="address" class="am-form-field  my-radius" placeholder="街道详细信息">
        </div>
        <div class="am-form-group am-form-icon">
            <i class="am-icon-envelope" style="color:#e9c740"></i>
            <input type="text" name="postcode" class="am-form-field  my-radius" placeholder="请输入邮箱号码">
        </div>
