...
<div class="container">
    ...
    <div class="am-cf mg10">
        <table class="am-table am-table-striped am-table-hover comm-table">
            <tbody>
            <tr >
                <td style="width: 40%;font-size: 120%">张三张三张三张三张三张三</td>
                <td style="width: 25%;font-size: 100%" >2017年2月</td>
                <td style="width: 15%;font-size: 120%">￥300.00</td>
                <td class="am-text-right" style="width: 10%;font-size: 120%"><a style="font-size: 100%" href="" class="am-badge am-badge-secondary am-radius">转账</a></td>
            </tr>
            <!-- <tr>
