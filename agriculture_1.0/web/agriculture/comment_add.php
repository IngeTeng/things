       ...
       /* $('#btn_return').click(function () {
        ...
        //添加工单
                $('#btn_submit').click(function(){
                    ...
                    var nikname           = "<?php echo $nikname;?>";
                    var order_detailid    = "<?php echo $order_detailid;?>";
                    var productid         = "<?php echo $productid;?>";
                    var desc              = document.getElementById('doc-ta-1').value;
                    console.log(desc);
                    ...
                    $.ajax({
                        ...
                        dataType : 'json',
                        url      : '../../admin/comment_do.php?act=add',
                            ...
                            switch(code){
                                case 1:
                                    layer.msg(msg, function(index){
                                        location.href = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=<?php echo $appid;?>&redirect_uri=<?php echo urlencode("http://www.yanxin325.com/agriculture_1.0/web/agriculture/order_list.php");?>?choice=0&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect';
                                    });
                                    break;
                                default:
                                    layer.msg(msg);
        ...
        <div class="am-cf" style="margin-bottom: 10px">
            <div class="am-u-sm-12">
                <div class="am-form-group am-text-center">
                    <textarea class="" name="desc" rows="8" id="doc-ta-1" style="width: 80%;margin: 20px auto"></textarea>
                </div>
            </div>
        </div>
        <p class="am-text-center"><button type="submit" id="btn_submit" class="am-btn am-btn-danger am-radius">提交</button></p>
