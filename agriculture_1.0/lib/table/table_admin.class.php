...
class Table_admin extends Table {
    ...
    /**
     * Table_admin::getInfoByPhone() 根据phone获取详情
     * 
     * @param Integer $adminId  管理员ID
     * 
     * @return
    ...
    static public function getInfoByPhone($phone){
        ...
        $sql = "select * from ".$mypdo->prefix."admin where admin_phone = $phone limit 1";
    ...
    /**
     * Table_admin::getInfoByOpenid() 根据ID获取详情
     * 
     * @param Integer $adminId  管理员ID
     * 
     * @return
    ...
    static public function getInfoByOpenid($openid){
        ...
        $sql = "select * from ".$mypdo->prefix."admin where admin_openid = $openid limit 1";
        //var_dump($sql);
        $rs = $mypdo->sqlQuery($sql);
        if($rs){
            $r = array();
    ...
    static public function edit($id, $account,$phone,$name,$openid,$group){
    	...
    	$param = array (
            ...
            'admin_openid'    => array('string' ,$openid),
