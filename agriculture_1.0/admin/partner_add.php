...
<div id="container">
    ...
    <div id="maincontent">
        <div id="position">当前位置：<a href="partner_list.php">加盟商管理</a> &gt; 添加加盟商</div>
        <div id="formlist">
            <p>
                <label>真实姓名</label>
                <input name="name" type="text" class="text-input input-length-10" />
                <span class="warn-inline">*</span>
            </p>
            <p>
                <label>加盟商店铺名</label>
                <input name="company" type="text" class="text-input input-length-20" />
                <span class="warn-inline">*</span>
            </p>
            <p>
                <label>微信昵称</label>
                <input name="nikname" type="text" class="text-input input-length-20" />
                <span class="warn-inline">*</span>
            </p>
            <p>
                <label>微信识别号</label>
            ...
            <p>
                <label>登陆账号</label>
                <input name="account" type="text" class="text-input input-length-10" />
                <span class="warn-inline">*</span>
            </p>
            <p>
                <label>登陆密码</label>
                <input name="password" type="text" class="text-input input-length-10" />
                <span class="warn-inline">*</span>
            </p>
            <p>
                <label>审核状态</label>
            ...
            <p>
                <label>电话</label>
                <input name="phone" type="text" class="text-input input-length-10" />
                <span class="warn-inline">*</span>
            </p>
             <p>
                <label>详细住址</label>
                <input name="address" type="text" class="text-input input-length-30" />
                <span class="warn-inline">*</span>
            </p>
            
            <p>
                <label>转账二维码</label>
                <input name="qrcode" type="text" readonly="readonly" class="text-input input-length-30 readonlyinput" value=""/>
            ...
            <p>
                <label>预售产品信息</label>
                <div style="margin-left:156px;width:80%;"><textarea name="product" id="ck_content"></textarea></div>
            </p>
            <p>
                <label>&nbsp;</label>
