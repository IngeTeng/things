            ...
            <div id="maincontent">
                ...
                <div id="formlist">
                    ...
                    <p>
                       ...
                       <span class="warn-block">* 文件格式：jpg。 图片尺寸：宽640px高640px。</span>
                        <span class="warn-block" id="picpreview"></span>
                    </p>
                    
                    <p>
                        <label>商品价格</label>
                        <input name="price" type="text" class="text-input input-length-30" />
                        <span class="warn-inline">*</span>
                    </p>
                    <p>
                        <label>商品库存</label>
                        <input name="num" type="text" class="text-input input-length-30" />
                        <span class="warn-inline">*</span>
                    </p>
                    <p>
                        <label>商品分类</label>
                    ...
                    <p>
                        <label>是否促销</label>
                        <select name="issale" class="select-option" id="product_issale">
                    ...
                    <p>
                        <label>促销价格</label>
                        <input name="sale_price" type="text" class="text-input input-length-30" />
                        <span class="warn-inline"></span>
                    </p>
                    <p>
                        <label>物流单价</label>
                        <input name="post_price" type="text" class="text-input input-length-30" />
                        <span class="warn-inline">*</span>
                    </p>
