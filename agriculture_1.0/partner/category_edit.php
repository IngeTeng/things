...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="maincontent">
                <div id="position">当前位置：<a href="category_list.php">分类管理</a> &gt; 修改分类</div>
                <div id="formlist">

                    <p>
                        <label>分类名称</label>
                        <input name="title" type="text" class="text-input input-length-30" value="<?php echo $category_title?>"/>
                        <span class="warn-inline">*</span>
                    </p>
                    <p>
                        <label>分类图片</label>
                        <input name="pic" type="text" value="<?php echo $category_pic?>" readonly="readonly" class="text-input input-length-30 readonlyinput" value=""/>
                        <span class="warn-inline">*</span>
                        ...
                        <span class="warn-block" id="picpreview"><img src="<?php echo $HTTP_PATH.$category_pic?>" width="100"/></span>
                    </p>
                               ...
                               $cateids = Category::getOptions($rc);
                                if(!empty($cateids)){
                                    ...
                                    foreach($keys as $key){
                                        ...
                                        if($category_parent == $key) echo ' selected ';
