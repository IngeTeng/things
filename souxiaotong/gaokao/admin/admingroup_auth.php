			...
			<div id="maincontent">
				...
				<div id="formlist" style="padding:0 40px;">
					...
					<p>
						...
						<input type="checkbox" class="checkbox-input" value="7004" <?php if(in_array(7004, $groupAuth)) echo 'checked';?> /><span class="radio-text">数据管理</span>
						<input type="checkbox" class="checkbox-input" value="7005" <?php if(in_array(7005, $groupAuth)) echo 'checked';?> /><span class="radio-text">统计管理</span>
                        <input type="checkbox" class="checkbox-input" value="7006" <?php if(in_array(7005, $groupAuth)) echo 'checked';?> /><span class="radio-text">预测管理</span>
