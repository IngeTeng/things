...
$HTTP_PATH = 'http://www.yanxin325.com/souxiaotong/gaokao/';              //网站访问路径，根据实际情况修改

//数据库连接参数设置=======================================
$DB_host   = '127.0.0.1';                                 //数据库地址
$DB_user   = 'admin';                                      //数据库用户
$DB_pass   = 'admin';                                      //数据库用户密码
$DB_name   = 'gaokao';                                     //数据库名称
$DB_prefix = 'gaokao_';                                    //表前缀，可以为空


//微信参数设置=============================================
//$appid='wxc8f5291782d61fa0';
$appid='wx305233f0667fe890';
$scope='snsapi_userinfo';
//$secret = "6b6a3b440f278255728643e75fc9720b"; 
$secret = "cd77b3d8bd117127aa90e66b73e0e909"; 
