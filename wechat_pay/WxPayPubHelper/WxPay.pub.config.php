...
class WxPayConf_pub
{
	...
	//=======【证书路径设置】=====================================
	//证书路径,注意应该填写绝对路径
	const SSLCERT_PATH = 'http://www.hechangyl.com/wechat_pay/WxPay/cacert/apiclient_cert.pem';
	const SSLKEY_PATH = 'http://www.hechangyl.com/wechat_pay/WxPay/cacert/apiclient_key.pem';
